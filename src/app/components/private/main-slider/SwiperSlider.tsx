...
export default function SwiperSlider({ slider }: { slider: Slider }) {
  return (
    <div className="swiper-slider shrink-0 basis-full relative after:content-[''] after:absolute after:inset-0 after:bg-[rgba(0,0,0,.35)] after:z-[80] xsm:content-none rounded-[1rem] xsm:block flex flex-col gap-2 justify-center items-center overflow-hidden">
      <img
